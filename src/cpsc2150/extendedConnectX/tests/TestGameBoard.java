...
public class TestGameBoard {
    ...
    private IGameBoard IGameBoardFactory(int r, int c, int numToWin) {
        return new GameBoard(r, c, numToWin);
    }
    ...
    public void constructor_validInitialization() {
        ...
        // create an IGameBoard object using the IGameBoardFactory
    ...
    // checks correct initialization of the gameboard with an empty board
    @Test
    ...
    public void checkIfFreeTest2_full_board() {
        ...
        IGameBoard gb = new GameBoard(row, col, numToWin);
    ...
    public void checkHorizWinAllRowsAllFull() {
        ...
        IGameBoard gb = IGameBoardFactory(5, 5, 5);
    ...
    public void checkHorizWinTestWithOpponentOnSameRow() {
        ...
        // factory call to create obj
        IGameBoard gb = IGameBoardFactory(5, 8, 3);
        for(int i = 0; i < 8; i++){
            if(i < 5){
                if(i % 2 == 0){
                    gb.dropToken(tempToken, i);
    ...
    // check for a vertical win being detected with a large board size
    @Test
    ...
    public void test_checkDiagWin_NW_SE_EndToEnd() {
        ...
        IGameBoard gb = IGameBoardFactory(ROWS, COLUMNS, NUM_TO_WIN);
    ...
    // test for a tie when the board is full with a single token
    @Test
    ...
    // cpsc2150.extendedConnectX.tests for a tie when the board is filled with different tokens
    @Test
    ...
    // checks that there is no tie detected if the board is not full
    @Test
    ...
    // checks for no tie when the board is empty
    @Test
    ...
    // cpsc2150.extendedConnectX.tests whatsAtPos on the top-left most board position
    @Test
    ...
    // cpsc2150.extendedConnectX.tests whatsAtPos on the botton-left most board position
    @Test
    ...
    // checks whatsAtPos on the top-right most board position
    @Test
    ...
    // cpsc2150.extendedConnectX.tests whatsAtPos on the bottom-right most position
    @Test
    ...
    // cpsc2150.extendedConnectX.tests whatsAtPos on an empty board position
    @Test
    ...
    // cpsc2150.extendedConnectX.tests isPlaterAtPos on the top-left most board position
    @Test
    ...
    // cpsc2150.extendedConnectX.tests isPlayerAtPos on the bottom-left most board position
    @Test
    ...
    // cpsc2150.extendedConnectX.tests isPlayerAtPos on the top-left most board position
    @Test
    ...
    // cpsc2150.extendedConnectX.tests isPlayerAtPos on the bottom-right most board position
    @Test
    ...
    // cpsc2150.extendedConnectX.tests isPlayerAtPos on an empty board position
    @Test
    public void test_isPlayerAtPos_EmptyPosition() {
        ...
        assertTrue(gb.isPlayerAtPos(bp, ' '));

    }

    // 5 cpsc2150.extendedConnectX.tests for dropToken

    // cpsc2150.extendedConnectX.tests dropToken on a single token in the middle column
    @Test
    ...
    // cpsc2150.extendedConnectX.tests dropToken when an entire column is filled
    @Test
    ...
    // cpsc2150.extendedConnectX.tests dropToken when the last column is partially filled
    @Test
